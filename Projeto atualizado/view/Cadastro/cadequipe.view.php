 ...
 ?>
  ...
  <body class="blue">
    ...
    <main>
      ...
      <!-- <form class="box cadastro" action="../../app/checarcnpj.php" method="post"/> -->
      ...
      <div class="">
        ...
        <input type="text" name="cidadee"  autocomplete="off"  placeholder="Ex:Rio de Janeiro" required></p>
          <p>
            <label>Estado:</label><br/>
        <input type="text" name="estadoe"  autocomplete="off" maxlength="2" placeholder="Ex:RJ" required></p>
          <p>
