  ...
  <body class="blue">
    ...
    <?php
      ...
      while( $row = $result->fetch_assoc()){
        ...
        <input type='text' name='empresa' value='$empresa' placeholder='Empresa'/></p>
        <p> <label>Endereço:</label> <br>
        <input type='text' name='endereco' value='$endereco' placeholder='Endereço'/></p>
        <p> <label>Telefone:</label> <br>
        <input type='text' name='telefone' class='tel' value='$telefone' placeholder='Telefone'/></p>
        <p> <label>E-mail:</label> <br>
        <input type='text' name='email' value='$email' placeholder='E-mail'/></p>

        <input type='hidden' name='senha' value='$senha' placeholder='Senha'/> <br>
