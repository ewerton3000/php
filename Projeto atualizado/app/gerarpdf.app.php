<?php
 session_start();
   ...
   include("../PDF/src/Cezpdf.php");//puxando a biblioteca do arquivo pdf
   include("../includes/mascara.php");//puxandos as mascaras de cpf/cnpj
   include("../includes/conecta.php");

     //égando as informaçoes do pedido
  ...
  //puxando todos os pedidos feitos na equipe
